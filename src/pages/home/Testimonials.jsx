...
function Testimonials(props) {
    ...
    return (
        <section className="int-track-section int-track-section-testimonial">
            <div className="int-track-testimonial-heading int-track-text-black int-track-fw-500 int-track-f-48">
                <div>Hear, what others </div>
                <div className="int-track-text-pink int-track-fw-700">have to say</div>
            </div>
            <div className="int-track-slider-container">
                <Slider {...settings}>
                    {
                        testimonial.map((item, idx) => {
                            return (
                                <div className="int-track-outer-testimonial-card" key={idx}>
                                    <div className="int-track-testimonial-card">
                                        <div className="int-track-testimonial-card-top">
                                            <div className="int-track-tct-l">
                                                <div className="int-track-tct-icon" style={item.iconStyle}>
                                                    {item.name.charAt(0)}
                                                </div>
                                                <div className="int-track-tct-about">
                                                    <div className="int-track-tct-name">{item.name}</div>
                                                    <Star count={item.star} />
                                                </div>
                                            </div>
                                            <div className="int-track-tct-r">
                                        ...
                                        <div className="int-track-testimonial-card-bottom">
                                            {item.message}
                                        </div>
                                    </div>
                                </div>
