...
function Footer(props) {
    return (
        <section className="int-track-section int-track-section-footer">
            <div className="int-track-footer">
                <div className="int-track-footer-sec int-track-footer-sec1">
                    <h4 className="int-track-footer-sec-heading">Other Links</h4>
                    <div className="int-track-footer-sec-links">
                ...
                <div className="int-track-footer-sec int-track-footer-sec2">
                    <h4 className="int-track-footer-sec-heading">Social Links</h4>
                    <div className="int-track-footer-sec-links int-track-">
                        <NavLink className="int-track-social-links" to={"/"}>
                ...
                <div className="int-track-footer-sec int-track-footer-sec3">
                    <h4 className="int-track-footer-sec-heading">Contact Us</h4>
                    <div className="int-track-footer-sec-links">
                        <p className="int-track-footer-email">
                            support@tutedude.com
                        </p>
                        <p className="int-track-footer-phone">
                            +91 7988800474
                        </p>
                    </div>
                </div>
                <div className="int-track-footer-sec int-track-footer-sec4">
                    <h4 className="int-track-footer-sec-heading">Registered Office</h4>
                    <div className="int-track-footer-sec-links">
                        <div className="int-track-footer-address">
